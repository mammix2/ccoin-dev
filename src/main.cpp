...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uCCN
...
void SetGenesisHash() {
        // Genesis Block:
        // CBlock(hash=000000000019d6, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=4a5e1e, nTime=1391808443, nBits=1d00ffff, nNonce=2083236893, vtx=1)
...
unsigned char pchMessageStart[4] = { 0x43, 0xcd, 0xd8, 0x19 };
