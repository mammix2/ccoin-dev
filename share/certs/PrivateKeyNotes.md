...
unlocked to sign the Ccoin-Qt.app bundle.
...
allowing somebody to distribute a Ccoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the ccoin-qt.exe file inside the installer had not been tampered with.
